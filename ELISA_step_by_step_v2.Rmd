...
### Notes on Folder Organization
  ...
  - You need to create a folder that holds all the raw data and information per plate
  - Folder names should be formatted as **PLATE_n_YYYYMMDD** (see examples below)
  ![](./ELISA_step_by_step_v2_files/FOLDER_ORGANIZATION.png){width=40%}
...
![](./ELISA_step_by_step_v2_files/ELISA_TEMPLATE.png)
  ...
  - **STIM_DAYS** contains the **stimulation days** (numeric, e.g. 1,2,3,..)
    ...
    ![](./ELISA_step_by_step_v2_files/STIM_DAYS.png)
  ...
  - **STIM_TIME** means how long you stimulated the cells
    ...
    ![](./ELISA_step_by_step_v2_files/STIM_TIME_2.png)

  - **STIM_CONCENTRATION** means how high was the stimulation concentration with your stimulant (**IL-1ß**, **LPS**)?
  ...
  - **DILUTIONS** --> Did you dilute the samples? 
    ...
    ![](./ELISA_step_by_step_v2_files/DILUTIONS.png)
